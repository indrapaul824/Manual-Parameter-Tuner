...
def main():
    ...
    st.markdown("# Heart Disease Prediction - Manual Parameter Tuner https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/271/anatomical-heart_1fac0.png")
